describe("linkedList", function () {
  ...
  //  it(`insertAt should return -1 if inserting
  //     a value outside the index range`,
  //   function () {
  //     linkedList.insertFirst(20);
  //     linkedList.insertLast(330);
  //     expect(linkedList.insertAt(20, 3)).to.equal(-1);
  // });
  ...
  // it('getAt should return -1 if value doesn\'t exist', function () {
  //   expect(linkedList.getAt(2)).to.equal(-1);
  // })
